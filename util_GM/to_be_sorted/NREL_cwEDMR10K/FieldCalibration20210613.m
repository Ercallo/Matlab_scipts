%% FIELD CALIBRATION
% This spectrum of NaC60 was acquired without using the teslameter and will
% be used as calibration for all the measurements without teslameter.
clear, clc, close all

%% Import
[data.B, data.spc, Params] = eprload('NaC60_Field_Calibration.DTA');
...
%%
% esfit('pepperFieldOffset', data.spc, Sys, Vary,  Exp);
