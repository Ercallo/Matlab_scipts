%% FIELD CALIBRATION
% This spectrum of NaC60 was acquired using the teslameter and will
% be used as calibration for all the measurements with teslameter.
clear, clc, close all

%% Import
[data.B, data.spc, Params] = eprload('018_calibration_NaC60_288K');
