...
addpath('D:\Profile\out\Desktop\Dati\Denver_Samples\20210622')
clearvars;
clc;
clear;
%clf;
figure(1)
%% Script parameters
Opt.File = '017_1p0V_PEDMR_Field_Sweep_26p7dB_200ns_17scan_20K_Light_longer_timebase.DTA';
Opt.TimeBaselineWidth = 4; % in µs
Opt.FieldBaselineWidth = 1; % in mT at both sides of the spectrum
...
subplot(1, 3, 3);
imagesc(y, x(1500:end), z(1500:end,:));
